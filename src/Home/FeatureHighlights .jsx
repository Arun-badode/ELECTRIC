    ...
    <section className="py-5 bg-white">
      <div className="container px-4">
        <div className="row text-center g-4">
          ...
          <div className="col-md-6 col-lg-3">
            <div className="rounded-circle bg-primary bg-opacity-10 d-flex align-items-center justify-content-center mx-auto mb-3" style={{ width: "64px", height: "64px" }}>
              <i className="ri-shield-check-line text-primary fs-4"></i>
            </div>
          ...
          <div className="col-md-6 col-lg-3">
            <div className="rounded-circle bg-primary bg-opacity-10 d-flex align-items-center justify-content-center mx-auto mb-3" style={{ width: "64px", height: "64px" }}>
              <i className="ri-customer-service-2-line text-primary fs-4"></i>
            </div>
          ...
          <div className="col-md-6 col-lg-3">
            <div className="rounded-circle bg-primary bg-opacity-10 d-flex align-items-center justify-content-center mx-auto mb-3" style={{ width: "64px", height: "64px" }}>
              <i className="ri-secure-payment-line text-primary fs-4"></i>
            </div>
